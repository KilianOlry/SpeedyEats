    ...
    <div class="card-hover">
      <div class="card-hover__content">
        ...
        <a href="<?= PATH_LINK_PAGE . 'products' . '&category=' . $data['id'] ?>" class="card-hover__link">
          ...
          <img src="<?= PATH_ICON . 'arrow.svg' ?>" alt="icone en savoir plus" class="arrow">
        </a>
      </div>
      <div class="card-hover__extra">
        <h4><?= $data['description'] ?></h4>
      </div>
      <img class="img__category" src="<?= PATH_IMAGE_CATEGORY . $data['image'] ?>" alt="Image catégorie de plat">
    </div>
  <?php endforeach; ?>
</div>